...
public class IndexController extends BaseController
{
    ...
    @ResponseBody
    public AjaxResult getNoticelist(Notice notice){
        List<Notice> notices = iNoticeService.selectNoticeList(notice);
        return AjaxResult.success(notices);

    }
    @GetMapping("/noticedetail/{id}")
    public String noticeDetail(@PathVariable("id") Long id, ModelMap modelMap){
